...
export const selectTaxonomies = createSelector(
  ...
  (id, taxonomies, categories, associations) => prepareTaxonomiesAssociated(taxonomies, categories, associations, 'tags_users', 'user_id', id)
);
...
export const selectRoles = createSelector(
  ...
  (state) => selectEntities(state, 'roles'),
  (state) => selectEntities(state, 'user_roles'),
  (id, roles, userRoles) => entitiesSetAssociated(roles, 'role_id', userRoles, 'user_id', id)
);
