...
export const selectTaxonomies = createSelector(
  ...
  (id, taxonomies, categories, associations) => prepareTaxonomiesIsAssociated(taxonomies, categories, associations, 'tags_recommendations', 'recommendation_id', id)
);
...
export const selectMeasuresAssociated = createSelector(
  ...
  (id, entities, associations) => entitiesIsAssociated(entities, 'measure_id', associations, 'recommendation_id', id)
);
...
export const selectIndicatorsAssociated = createSelector(
  ...
  (id, entities, associations) => entitiesIsAssociated(entities, 'indicator_id', associations, 'recommendation_id', id)
);
...
export const selectIndicators = createSelector(
  ...
  (state) => selectEntities(state, 'measure_indicators'),
  (state) => selectEntities(state, 'recommendation_indicators'),
  (indicators, connections, indicatorMeasures, indicatorRecs) => indicators && indicatorRecs && indicators
