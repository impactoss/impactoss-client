...
const icons = {
  ...
  smart_0: {
    size: 40,
    paths: [
      'M27,21l2-2V29H11V11H24l-2,2H13V27H27Z',
      'M16.53,16l-2.12,2.12,5.66,5.66,2.12-2.12,9.9-9.9L30,9.68l-9.9,9.9Z',
    ],
  },
  // m: measureable
  smart_1: {
    size: 40,
    paths: [
      'M31,28v2H9V28h3V19h4v9h2V15h4V28h2V11h4V28Z',
    ],
  },
  // a: assignable
  smart_2: {
    size: 40,
    paths: [
      'M31,9A4.1,4.1,0,0,0,25.3,9,4,4,0,0,0,31,14.7,4,4,0,0,0,31,9Zm-1.41,4.24a2,2,0,1,1,.58-1.41A2,2,0,0,1,29.55,13.28Z',
      'M16.82,17.53,24.6,15.4l-2.13,7.78-2.12-2.12L15.3,26.11a4,4,0,1,1-1.41-1.41l5.05-5.05Z',
    ],
  },
  // r: result-oriented
  smart_3: {
    size: 40,
    paths: [
      'M27.61,15.22l1.45-1.45a11,11,0,1,1-2.83-2.83l-1.45,1.45A8.86,8.86,0,0,0,20,11a9,9,0,1,0,9,9A8.86,8.86,0,0,0,27.61,15.22Zm-10.44,2A4,4,0,0,1,20,16a3.87,3.87,0,0,1,1,.15l1.56-1.56a6,6,0,1,0,2.83,2.83L23.85,19A3.87,3.87,0,0,1,24,20a4.09,4.09,0,0,1-4,4,4,4,0,0,1-2.83-6.83Z',
      'M32,5.15,28.49,8.69V10.1l-9.2,9.19,1.42,1.42,9.19-9.2h1.41L34.85,8H32Z',
    ],
  },
  // t: time-bound
  smart_4: {
    size: 40,
    paths: [
      'M9,30H31V15H9Zm2.09-13H28.91V28H11.09Z',
      'M13,19h4v3H13Zm5,0h4v3H18Zm5,0h4v3H23ZM13,23h4v3H13Zm5,0h4v3H18Zm5,0h4v3H23Zm8-13v4H9V10h2V9h2v3h1V10H26V9h2v3h1V10Z',
    ],
  },
};
