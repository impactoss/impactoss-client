...
const icons = {
  ...
  connectedCategories: {
    size: 24,
    paths: [
      'M17.49,6.5a1,1,0,0,1,.75.34,1,1,0,0,1,.25.79l-.56,5.06a.24.24,0,0,1-.07.14l-6.6,6.6a.24.24,0,0,1-.34,0L5.57,14.08a.24.24,0,0,1,0-.34l6.6-6.6a.24.24,0,0,1,.14-.07l5.06-.56h.12m0-1h-.23l-5.06.56a1.24,1.24,0,0,0-.74.36L4.86,13a1.24,1.24,0,0,0,0,1.76l5.35,5.35a1.24,1.24,0,0,0,1.76,0l6.6-6.6a1.24,1.24,0,0,0,.36-.74l.56-5.06a2,2,0,0,0-2-2.23Z" style="fill:#1d3033"/><path d="M17,9.88A1.36,1.36,0,1,1,17,8,1.36,1.36,0,0,1,17,9.88Z',
    ],
  },
  sdgTargets: {
    size: 24,
  ...
  calendar: {
    ...
    paths: [
      ...
      'M10.36,14h3.27v3.24H10.36Z" style="fill:#1d3033',
    ],
  },
  reminder: {
    size: 24,
