...
const icons = {
  ...
  taxonomy_1: {
    size: 40,
    paths: [
      'M31,5H9v15.45c.33-.06.66-.09,1-.09,3.31,0,6,2.69,6,6,0,1.81-.81,3.41-2.08,4.51-.26.23-.54.43-.84.61-.03.02-.05.03-.07.05-.31.18-.63.34-.98.47-.63.23-1.31.36-2.03.36-1.32,0-2.53-.43-3.52-1.15v5.64l3.72-2.48,3.72,2.48v-4.85h17.08V5ZM12.5,9.61h15v1h-15v-1ZM12.5,12.61h15v1h-15v-1ZM12.5,15.61h15v1h-15v-1ZM12.5,19.61v-1h7v1h-7ZM28,27.61h-3.8c-1.1,0-1.69,0-2.02-.05-.12.21-.25.45-.39.72-.14.28-.46.92-.97.92-.05,0-.1,0-.15-.02-.62-.15-.75-.99-.77-2.71-.32.26-.75.69-1.05.99l-.71-.71c1.11-1.11,1.72-1.68,2.3-1.44.21.09.45.3.45.84,0,.75.02,1.24.06,1.57.89-1.75,1.64-2.57,2.26-2.42.16.04.54.2.54.85,0,.17-.04.32-.11.45h4.36v1ZM10,21.36c-.34,0-.68.04-1,.1-2.28.46-4,2.48-4,4.9s1.72,4.43,4,4.9c.32.07.66.1,1,.1,2.76,0,5-2.24,5-5s-2.24-5-5-5ZM10,29.02c-1.47,0-2.66-1.19-2.66-2.66s1.19-2.66,2.66-2.66,2.66,1.19,2.66,2.66-1.19,2.66-2.66,2.66Z',
    ],
  },
  // 2: UN session
  taxonomy_2: {
  ...
  taxonomy_3: {
    size: 40,
    paths: [
      'M6.68,25.18l.95,2.92h-2.9l.95-2.92h1ZM7.65,9.69c0-4.14,3.36-7.5,7.5-7.5s7.5,3.36,7.5,7.5-3.36,7.5-7.5,7.5-7.5-3.36-7.5-7.5ZM10.32,11.3h3.21v3.21h3.21v-3.21h3.21v-3.21h-3.21v-3.21h-3.21v3.21h-3.21v3.21ZM38.39,20.66c0,4.69-3.81,8.5-8.5,8.5s-8.5-3.81-8.5-8.5,3.81-8.5,8.5-8.5,8.5,3.81,8.5,8.5ZM33.46,20.93h-7.14v3.8h7.14v-3.8ZM34.43,19.8l-4.54-4.54-4.54,4.54h9.09ZM20.61,28.31c0,5.25-4.25,9.5-9.5,9.5S1.61,33.56,1.61,28.31s4.25-9.5,9.5-9.5,9.5,4.25,9.5,9.5ZM17.94,28.1h-.32l-1.24-3.83h-.41v-.7h-4.18v-.9h-1.92v.9h-4.3v.7h-.55l-1.24,3.83h-.32v.94c0,.98.79,1.77,1.77,1.77h1.89c.98,0,1.77-.79,1.77-1.77v-.94h-.32l-1.17-3.62h2.46v8.14h-.19c-.9,0-1.62.73-1.62,1.62v.45h5.54v-.45c0-.89-.73-1.62-1.62-1.62h-.19v-8.14h2.21l-1.17,3.62h-.32v.94c0,.98.79,1.77,1.77,1.77h1.89c.98,0,1.77-.79,1.77-1.77v-.94ZM14.72,25.18l-.95,2.92h2.9l-.95-2.92h-1Z',
    ],
  },
  ...
  taxonomy_4: {
    size: 40,
    paths: [
      'M21,25c0,1.1-.9,2-2,2s-2-.9-2-2,.9-2,2-2,2,.9,2,2ZM17,21h4v-10h-4v10ZM36.62,36.07l-2.04,2.04c-.61.61-1.59.61-2.2,0l-5.56-5.56.71-.71-1.04-1.04c-2.17,1.38-4.73,2.19-7.48,2.19-7.72,0-14-6.28-14-14s6.28-14,14-14,14,6.28,14,14c0,3.52-1.32,6.74-3.47,9.2l.83.83.71-.71,5.56,5.56c.61.61.61,1.59,0,2.2ZM19,30c6.07,0,11-4.93,11-11s-4.93-11-11-11-11,4.93-11,11,4.93,11,11,11Z',
    ],
  },
  // 5: Affected persons
  taxonomy_5: {
  ...
  taxonomy_small_1: {
    size: 18,
    paths: [
      'M14,2.31H4.43v6.03c.18-.03.36-.05.54-.05,1.79,0,3.24,1.45,3.24,3.24,0,.98-.44,1.84-1.12,2.44-.14.12-.29.23-.45.33-.01,0-.03.02-.04.03-.17.1-.34.19-.53.25-.34.12-.71.19-1.09.19-.71,0-1.37-.23-1.9-.62v3.05l2.01-1.34,2.01,1.34v-2.62h6.91V2.31ZM4.97,9.53c-.14,0-.27.01-.4.04-.91.19-1.6.99-1.6,1.96s.69,1.77,1.6,1.96c.13.03.26.04.4.04,1.1,0,2-.9,2-2s-.9-2-2-2Z',
    ],
  },
  // 2: UN session
  taxonomy_small_2: {
    size: 18,
    paths: [
      'M15.25,9c0,3.11-2.28,5.68-5.25,6.16v1.84l-4-2.5,4-2.5v1.64c2.14-.46,3.75-2.37,3.75-4.64,0-1.69-.89-3.18-2.23-4.02l1.01-.63.36-.23c1.43,1.15,2.36,2.91,2.36,4.88ZM4.25,9c0-2.28,1.61-4.18,3.75-4.64v1.64l4-2.5L8,1v1.84c-2.97.48-5.25,3.06-5.25,6.16,0,1.97.92,3.73,2.36,4.88l.36-.23,1.01-.63c-1.34-.84-2.23-2.33-2.23-4.02Z',
    ],
  },
  // 3: HR theme
  taxonomy_small_3: {
    size: 18,
    paths: [
      'M3.63,4.37c0-1.86,1.51-3.37,3.37-3.37s3.37,1.51,3.37,3.37-1.51,3.37-3.37,3.37-3.37-1.51-3.37-3.37ZM17.44,9.3c0,2.11-1.71,3.82-3.82,3.82s-3.82-1.71-3.82-3.82,1.71-3.82,3.82-3.82,3.82,1.71,3.82,3.82ZM9.45,12.73c0,2.36-1.91,4.27-4.27,4.27S.92,15.09.92,12.73s1.91-4.27,4.27-4.27,4.27,1.91,4.27,4.27Z',
    ],
  },
  // 4: Human rights issue
  taxonomy_small_4: {
    size: 18,
    paths: [
      'M16.79,15.87l-.96.96c-.29.29-.75.29-1.03,0l-2.61-2.61.33-.33-.49-.49c-1.02.65-2.22,1.03-3.52,1.03-3.63,0-6.58-2.95-6.58-6.58S4.88,1.27,8.51,1.27s6.58,2.95,6.58,6.58c0,1.65-.62,3.16-1.63,4.32l.39.39.33-.33,2.61,2.61c.29.29.29.75,0,1.03ZM8.51,12.34c2.48,0,4.5-2.02,4.5-4.5s-2.02-4.5-4.5-4.5-4.5,2.02-4.5,4.5,2.02,4.5,4.5,4.5Z',
    ],
  },
  // 5: Affected persons
  taxonomy_small_5: {
    size: 18,
    paths: [
      'M11.09,10.37c.03.29-.2.54-.5.54h-.39l-.27,3.9c-.02.29-.27.52-.57.52h-.47c-.3,0-.55-.23-.57-.52l-.27-3.9h-.39c-.29,0-.52-.25-.5-.54l.25-3.63c.04-.42.4-.74.82-.74h1.78c.42,0,.78.32.82.74l.25,3.63ZM9.12,5.51c.68,0,1.23-.55,1.23-1.23s-.55-1.23-1.23-1.23-1.23.55-1.23,1.23.55,1.23,1.23,1.23ZM6.17,10.37c.03.29-.2.54-.5.54h-.39l-.27,3.9c-.02.29-.27.52-.57.52h-.47c-.3,0-.55-.23-.57-.52l-.27-3.9h-.39c-.29,0-.52-.25-.5-.54l.25-3.63c.04-.42.4-.74.82-.74h1.78c.42,0,.78.32.82.74l.25,3.63ZM4.21,5.51c.68,0,1.23-.55,1.23-1.23s-.55-1.23-1.23-1.23-1.23.55-1.23,1.23.55,1.23,1.23,1.23ZM16,10.37c.03.29-.2.54-.5.54h-.39l-.27,3.9c-.02.29-.27.52-.57.52h-.47c-.3,0-.55-.23-.57-.52l-.27-3.9h-.39c-.29,0-.52-.25-.5-.54l.25-3.63c.04-.42.4-.74.82-.74h1.78c.42,0,.78.32.82.74l.25,3.63ZM14.04,5.51c.68,0,1.23-.55,1.23-1.23s-.55-1.23-1.23-1.23-1.23.55-1.23,1.23.55,1.23,1.23,1.23Z',
    ],
  },
  ...
  settings: {
    size: 40,
    paths: [
      'M15.92,36.67l-.78-5.28c-.47-.18-.96-.41-1.45-.69-.5-.29-.94-.59-1.34-.9l-4.93,2.19-4.11-7.19,4.43-3.28c-.05-.23-.07-.48-.08-.76,0-.27-.01-.53-.01-.76s0-.48.01-.76c0-.27.04-.53.08-.76l-4.43-3.28,4.11-7.19,4.93,2.19c.4-.31.85-.62,1.35-.9.5-.29.98-.51,1.44-.67l.78-5.31h8.17l.78,5.28c.47.18.96.4,1.46.68.5.28.95.58,1.33.92l4.93-2.19,4.11,7.19-4.43,3.22c.05.25.07.51.08.78,0,.27.01.53.01.78s0,.51-.01.77c0,.26-.04.52-.1.77l4.43,3.25-4.11,7.19-4.92-2.19c-.4.31-.84.62-1.33.92-.49.3-.98.52-1.46.68l-.78,5.28h-8.17ZM20.03,25.56c1.54,0,2.85-.54,3.93-1.63s1.63-2.39,1.63-3.93-.54-2.85-1.63-3.93-2.39-1.63-3.93-1.63-2.86.54-3.94,1.63c-1.08,1.08-1.62,2.39-1.62,3.93s.54,2.85,1.62,3.93c1.08,1.08,2.39,1.62,3.94,1.62Z',
    ],
  },
};
