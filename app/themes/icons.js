...
const icons = {
  ...
  taxonomy_5: {
    size: 40,
    paths: [
      'M34.87,13.43a3.12,3.12,0,0,0-3.12,3L29,17.08A4.72,4.72,0,0,0,27.23,15l2.32-4.73a3.18,3.18,0,0,0,.62.06,3.17,3.17,0,1,0-2-.76l-2.36,4.82a4.4,4.4,0,0,0-1.09-.14,4.67,4.67,0,0,0-2.56.76L17.07,9a3.13,3.13,0,1,0-2.55,1.32A3.19,3.19,0,0,0,15.87,10L21,16.05a4.64,4.64,0,0,0-1,2.86,4.7,4.7,0,1,0,9.39,0c0-.1,0-.2,0-.3L32.1,18a3.12,3.12,0,1,0,2.77-4.56Z',
      'M21.74,31.53a3.07,3.07,0,0,0-.41.48l-1.55-.78a4.65,4.65,0,0,0-4.48-6.06,4.79,4.79,0,0,0-1.36.23l-1.28-2.57.12-.1a3.13,3.13,0,1,0-4.42-.08,3.1,3.1,0,0,0,2.9.88l1.28,2.56a4.67,4.67,0,0,0-1.85,3H8.15a3.17,3.17,0,1,0,0,1.56h2.54a4.66,4.66,0,0,0,8.39,2l1.73.87a3.11,3.11,0,1,0,.93-2Z',
    ],
  },
  // 6: Organisation
  taxonomy_6: {
