...
const icons = {
  ...
  taxonomy_9: {
    size: 40,
    paths: [
      'M15,8.54,13.79,5.8A15.44,15.44,0,0,0,10.25,8l1.89,2.33A12.8,12.8,0,0,1,15,8.54Z',
      'M7.5,20c0-.36,0-.72,0-1.07l-3-.26c0,.44-.06.88-.06,1.33a16.49,16.49,0,0,0,.25,2.81l3-.54A13.3,13.3,0,0,1,7.5,20Zm2.34-7.29L7.41,11a15.16,15.16,0,0,0-1.95,3.66l2.81,1A12.86,12.86,0,0,1,9.84,12.71Z',
      'M20,4.5a14.84,14.84,0,0,0-2.21.16l.43,3A11.66,11.66,0,0,1,20,7.5,12.5,12.5,0,1,1,8.74,25.44L6,26.75a16,16,0,0,0,1.11,1.92A15.5,15.5,0,1,0,20,4.5Z',
    ],
  },
  // Icons
